    ...
    <AuthGuard>
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="space-y-6">
          ...
          {canEdit && showAddForm && (
            <section className="bg-white rounded-lg border-2 border-blue-300 p-6">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    placeholder="例: 課題管理"
                    className="w-full p-2 rounded border border-slate-300 text-sm focus:outline-none focus:ring-2 focus:ring-blue-300"
                  />
                </div>
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full p-2 rounded border border-slate-300 text-sm resize-y min-h-[60px] focus:outline-none focus:ring-2 focus:ring-blue-300"
                  />
                </div>
                <div>
                    ...
                    {newItems.map((item, i) => (
                      <li key={i} className="flex items-start gap-2">
                        ...
                        <textarea
                          ...
                          className="flex-1 p-2 rounded border border-slate-300 text-sm resize-y min-h-[36px] focus:outline-none focus:ring-2 focus:ring-blue-300"
                        />
                        {newItems.length > 1 && (
                          <button
