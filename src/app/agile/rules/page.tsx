                ...
                {isEditing ? (
                  <div className="space-y-4">
                    <textarea
                      ...
                      className="w-full p-2 rounded border border-slate-300 text-sm text-slate-600 resize-y min-h-[60px] focus:outline-none focus:ring-2 focus:ring-green-300"
                    />
                      ...
                      {editItems.map((item, i) => (
                        <li key={i} className="flex items-start gap-2">
                          ...
                          <textarea
                            ...
                            className="flex-1 p-2 rounded border border-slate-300 text-sm text-slate-700 resize-y min-h-[36px] focus:outline-none focus:ring-2 focus:ring-green-300"
                          />
                          <button
